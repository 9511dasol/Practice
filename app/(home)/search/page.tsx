            ...
            <div className="grid grid-cols-1 gap-3">
                {isLoading ? (
                    ...
                    filteredProjects.map((p) => (
                        ...
                        >
                            <div className={`w-14 h-14 rounded-2xl flex flex-col items-center justify-center font-black border shrink-0 ${p.dueDays < 0 ? 'bg-gray-200 text-gray-500 border-gray-300' :
