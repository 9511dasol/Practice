...
">
    ...
    ">
                ...
                <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-xl border-t border-gray-100 px-4 py-2 flex justify-around items-center z-50 pb-safe">
                    {/* 1. 홈/대시보드 */}
                    <Link href="/" className="flex flex-col items-center justify-center w-12 h-12 shrink-0">
                    ...
                    {/* 2. 파일 업로드 */}
                    <Link href="/upload" className="flex flex-col items-center justify-center w-12 h-12 shrink-0">
    ...
    `}>
                    ...
                    {/* 4. 직원 관리 (준비중) */}
                    <Link href="/staff" className="flex flex-col items-center justify-center w-12 h-12 shrink-0">
                    ...
                    {/* 5. 설정 (준비중) */}
                    <Link href="/settings" className="flex flex-col items-center justify-center w-12 h-12 shrink-0">
